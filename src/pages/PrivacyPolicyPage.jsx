    ...
    <div>
      ...
      <div className="my-8 flex flex-col md:flex-row gap-12">
        <div className="flex flex-col justify-center gap-3 md:w-3/4 mx-auto text-sm text-gray-600">
          ...
          <div className="text-sm text-gray-600">
            <p className="text-base md:text-lg"><strong>About the Privacy Policy:</strong> XYZ Clinic's Privacy Policy (the “Privacy Policy”) governs the processing of personal data collected from natural persons (“you” and “your”) through the online platform available at https://www.XYZ Clinic.com, the related domain names, and services (collectively, “XYZ Speech and Hearing Clinic”).</p>
            <p className="text-base md:text-lg mt-1"><strong>Owner of XYZ Clinic:</strong> XYZ Speech and Hearing Clinic is owned and operated by Lokesh (Sole Proprietor), located at ABC, XYZ, Delhi - 110039.</p>
          ...
          <div className="text-sm text-gray-600">
            ...
            <p className="text-base md:text-lg mt-1"><strong>How We Use Your Information:</strong></p>
            <ul className="list-disc pl-6 mt-1">
